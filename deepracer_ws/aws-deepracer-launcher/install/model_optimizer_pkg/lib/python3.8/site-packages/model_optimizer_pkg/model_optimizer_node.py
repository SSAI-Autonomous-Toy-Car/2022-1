...
class ModelOptimizerNode(Node):
    ...
    def model_optimizer_fake(self, req, res):
        self.get_logger().info("model_optimizer_fake")
        try:
            res.error = 0
            res.artifact_path = "/opt/aws/deepracer/artifacts/Sample_lidar_stereo_cam/model.xml"
